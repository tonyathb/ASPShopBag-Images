...
namespace ASPShopBag.Migrations
{
    ...
    [Migration("20220320121525_Images_v.0")]
    partial class Images_v0
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPShopBag.Data.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPShopBag.Data.Order", b =>
                {
                    ...
                    b.HasOne("ASPShopBag.Data.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASPShopBag.Data.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
